...
@Component({
  selector: 'app-modal-gestao-frigobar',
  templateUrl: './modal-gestao-frigobar.component.html',
  styleUrls: ['./modal-gestao-frigobar.component.scss']
})
export class ModalGestaoFrigobarComponent {
  selectedItemCategoria = "Frigobar"
    ...
    this.gestaoAtivosService.cadastrarAtivos(this.gestaoAtivos).subscribe(
      ...
      setTimeout(() => {
        this.router.navigateByUrl('/', { skipLocationChange: true }).then(() => {
          this.router.navigate(['/gestao-frigobar-ti']); // Navega para a rota de cadastro de armazém
        });
        }, 1000); 
      },
      error =>{
