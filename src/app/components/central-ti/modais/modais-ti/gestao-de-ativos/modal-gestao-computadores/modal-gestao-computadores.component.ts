...
@Component({
  selector: 'app-modal-gestao-computadores',
  templateUrl: './modal-gestao-computadores.component.html',
  styleUrls: ['./modal-gestao-computadores.component.scss']
})
export class ModalGestaoComputadoresComponent {
    ...
    this.gestaoAtivosService.cadastrarAtivos(this.gestaoAtivos).subscribe(
      ...
      setTimeout(() => {
        this.router.navigateByUrl('/', { skipLocationChange: true }).then(() => {
          this.router.navigate(['/gestao-computador-ti']); // Navega para a rota de cadastro de armazém
        });
        }, 1000); 
      },
      error =>{
