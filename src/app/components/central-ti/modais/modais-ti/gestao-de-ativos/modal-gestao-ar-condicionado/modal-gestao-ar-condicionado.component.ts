...
@Component({
  selector: 'app-modal-gestao-ar-condicionado',
  templateUrl: './modal-gestao-ar-condicionado.component.html',
  styleUrls: ['./modal-gestao-ar-condicionado.component.scss']
})
export class ModalGestaoArCondicionadoComponent {
  selectedItemCategoria = "Ar condicionado"
    ...
    this.gestaoAtivosService.cadastrarAtivos(this.gestaoAtivos).subscribe(
      ...
      setTimeout(() => {
        this.router.navigateByUrl('/', { skipLocationChange: true }).then(() => {
          this.router.navigate(['/gestao-ar-condicionado-ti']); // Navega para a rota de cadastro de armazém
        });
        }, 1000); 
      },
      error =>{
