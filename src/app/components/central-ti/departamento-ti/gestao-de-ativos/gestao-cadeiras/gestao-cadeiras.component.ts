...
import { ModalGestaoBebedourosComponent } from '../../../modais/modais-ti/gestao-de-ativos/modal-gestao-bebedouros/modal-gestao-bebedouros.component';
import { ModalGestaoCadeirasComponent } from '../../../modais/modais-ti/gestao-de-ativos/modal-gestao-cadeiras/modal-gestao-cadeiras.component';

@Component({
  selector: 'app-gestao-cadeiras',
  templateUrl: './gestao-cadeiras.component.html',
  styleUrls: ['./gestao-cadeiras.component.scss']
})
export class GestaoCadeirasComponent {
  ...
  openAdicionarAtivos() {
    this.dialog.open(ModalGestaoCadeirasComponent);
  }
