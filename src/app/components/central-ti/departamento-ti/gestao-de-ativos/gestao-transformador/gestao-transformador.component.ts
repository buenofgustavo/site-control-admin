...
import { ModalGestaoTransformadorComponent } from '../../../modais/modais-ti/gestao-de-ativos/modal-gestao-transformador/modal-gestao-transformador.component';

@Component({
  selector: 'app-gestao-transformador',
  templateUrl: './gestao-transformador.component.html',
  styleUrls: ['./gestao-transformador.component.scss']
})
export class GestaoTransformadorComponent {
  ...
  openAdicionarAtivos() {
    this.dialog.open(ModalGestaoTransformadorComponent);
  }
