...
@Component({
  selector: 'app-gestao-armarios',
  templateUrl: './gestao-armarios.component.html',
  styleUrls: ['./gestao-armarios.component.scss']
})
export class GestaoArmariosComponent {
  ...
  openAdicionarAtivos() {
    this.dialog.open(ModalGestaoArmariosComponent);
  }
