...
import { ModalGestaoArCondicionadoComponent } from '../../../modais/modais-ti/gestao-de-ativos/modal-gestao-ar-condicionado/modal-gestao-ar-condicionado.component';

@Component({
  selector: 'app-gestao-ar-condicionado',
  templateUrl: './gestao-ar-condicionado.component.html',
  styleUrls: ['./gestao-ar-condicionado.component.scss']
})
export class GestaoArCondicionadoComponent {
  ...
  openAdicionarAtivos() {
    this.dialog.open(ModalGestaoArCondicionadoComponent);
  }
