...
@Component({
  selector: 'app-gestao-cpd',
  templateUrl: './gestao-cpd.component.html',
  styleUrls: ['./gestao-cpd.component.scss']
})
export class GestaoCpdComponent {
  ...
  openAdicionarAtivos() {
    this.dialog.open(ModalGestaoCpdComponent);
  }
