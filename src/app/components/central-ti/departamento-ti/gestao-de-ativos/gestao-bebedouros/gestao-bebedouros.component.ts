...
@Component({
  selector: 'app-gestao-bebedouros',
  templateUrl: './gestao-bebedouros.component.html',
  styleUrls: ['./gestao-bebedouros.component.scss']
})
export class GestaoBebedourosComponent {
  ...
  openAdicionarAtivos() {
    this.dialog.open(ModalGestaoBebedourosComponent);
  }
