...
import { ModalGestaoMicroondasComponent } from '../../../modais/modais-ti/gestao-de-ativos/modal-gestao-microondas/modal-gestao-microondas.component';

@Component({
  selector: 'app-gestao-microondas',
  templateUrl: './gestao-microondas.component.html',
  styleUrls: ['./gestao-microondas.component.scss']
})
export class GestaoMicroondasComponent {
  ...
  openAdicionarAtivos() {
    this.dialog.open(ModalGestaoMicroondasComponent);
  }
