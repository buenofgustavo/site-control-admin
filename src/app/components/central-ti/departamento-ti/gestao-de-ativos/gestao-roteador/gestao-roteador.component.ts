...
import { ModalGestaoRoteadorComponent } from '../../../modais/modais-ti/gestao-de-ativos/modal-gestao-roteador/modal-gestao-roteador.component';

@Component({
  selector: 'app-gestao-roteador',
  templateUrl: './gestao-roteador.component.html',
  styleUrls: ['./gestao-roteador.component.scss']
})
export class GestaoRoteadorComponent {
  ...
  openAdicionarAtivos() {
    this.dialog.open(ModalGestaoRoteadorComponent);
  }
