...
export class ChamadosTiComponent {
  ...
  displayedColumns: string[] = ['titulo', 'usuarioVinculado', 'prioridade', 'status', 'acao'];
  ...
  atribuir(chamados: Chamados){
    const status = "Atribuido"
